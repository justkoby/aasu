  ...
  return (
    <div className="priority-area-page capacity-page">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .priority-hero { min-height: 75vh; position: relative; display: flex; align-items: flex-start; justify-content: flex-start; text-align: left; color: white; background: url('/donation-laptops.jpg') center/cover no-repeat; padding-top: 220px; padding-bottom: 60px; }
